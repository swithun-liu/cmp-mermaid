<div align="center">
  ...
  <p>
    ...
    ·
    <a href="docs/assets/stability-report/visual-parity-evidence.md"><strong>5,376-case visual report</strong></a>
    ·
...
> [!IMPORTANT]
> **CMP Mermaid currently implements 21 of Mermaid `12.0.0`'s 33 official
> diagram families.** The remaining 12 families are on the
> **[full-diagram roadmap](docs/full-diagram-roadmap.md)**.
>
> The current **[5,376-case Native/Official visual report](docs/assets/stability-report/visual-parity-evidence.md)**
> covers all 21 implemented families. Flowchart, XY Chart, Quadrant Chart,
...
> Treemap, Venn, and Ishikawa have completed the replacement 256-case detail
> gate. The report does not prove complete Mermaid compatibility because 12 official families remain
> untranslated.
...
The 21 implemented families retain repository-controlled tests and captures.
...
Mindmap, Packet, Radar, Sankey, Treemap, Venn, and Ishikawa pass the replacement detail gate.

| Evidence | Result |
| --- | ---: |
| Official Mermaid diagram families | 33 |
| Implemented diagram families | 21/33 |
| Translation pending | 12 |
| Independent production scenarios | 275 |
| Declared capability coverage | 424/424 |
| Large-scale visual matrix | 5,376 unique sources: 256 per implemented family |
| Native/Official captures | 10,752 matrix screenshots plus 550 independent-corpus screenshots |
| Matrix detail review | All 21 implemented families: 5,376/5,376 accepted; 4,889 automatic passes plus 487 manually accepted ER/Journey/Requirement/Git Graph/Mindmap/Treemap/Venn reviews |
| Automated visual geometry | 5,376/5,376 passed; all 21 implemented-family detail gates passed |
| Deterministic SceneGraph replay | 275 passed, 0 mismatches |
| Built-in theme matrix | 231/231 |
| Separate generated Native stress inputs | 5,376 |
| JVM tests | 543 passed, 0 failed |
| Core production soak | 1,375 renders, 436ms total, 1ms P95, 45,320 bytes retained heap |
| Runtime load matrix | Web passed all 275 current scenarios; Android, iOS, and Desktop retain the prior 236-scenario baseline |

| Evidence document | What it contains |
| --- | --- |
| **[Full diagram roadmap](docs/full-diagram-roadmap.md)** | Official 33-family inventory, current 21/33 state, missing 12 families, and the new Stable gate |
...
| **[All 5,376 Native/Official pairs](docs/assets/stability-report/visual-parity-evidence.md)** | 336 paged contact sheets, with 16 same-source pairs per page |
| [Production capability matrix](docs/production-capability-matrix.md) | The 424 independently exercised capabilities |
...
The report contains the 275 independent production comparisons and a separate
large-scale matrix with 5,376 unique Mermaid sources:
**[open all 336 visual evidence pages](docs/assets/stability-report/visual-parity-evidence.md)**.
...
All 21 implemented types support Mermaid frontmatter, relevant metadata, Unicode, and
