...
| Consumer | Artifact |
| --- | --- |
| Current Kotlin Multiplatform | `io.github.swithun-liu:mermaid-core:0.1.4` |
| Current Compose Multiplatform | `io.github.swithun-liu:mermaid-compose:0.1.4` |
| Android with Kotlin `1.7.21` | `io.github.swithun-liu:mermaid-core-android-kotlin17:0.1.4` |
| Android Compose with Kotlin `1.7.21` | `io.github.swithun-liu:mermaid-compose-android-kotlin17:0.1.4` |
| iOS binary | `CMPMermaid` CocoaPod `0.1.4` |

Current Kotlin Multiplatform projects:
```kotlin
dependencies {
    implementation("io.github.swithun-liu:mermaid-compose:0.1.4")
}
```
...
dependencies {
    implementation(
        "io.github.swithun-liu:mermaid-compose-android-kotlin17:0.1.4",
    )
}
```
