...
import io.github.cmpmermaid.core.flowchart.upstream.dagre.DagreNode
        ...
        private fun extractor(graph: DagreGraph, depth: Int) {
            ...
            graph.nodes().toList().forEach { id ->
                ...
                val clusterGraph = Graph<
                    io.github.cmpmermaid.core.flowchart.upstream.dagre.DagreNode,
                    io.github.cmpmermaid.core.flowchart.upstream.dagre.DagreEdge,
                    DagreGraphLabel,
                    >(
                    multigraph = true,
                    compound = true,
