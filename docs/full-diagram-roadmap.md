...
CMP Mermaid implements 20 of the 33 user-visible diagram families documented
...
| --- | --- |
| Implemented, 256-case detail gate passing | Flowchart, XY Chart, Quadrant Chart, Timeline, Kanban, Sequence, Class, State, Entity Relationship, Gantt, Pie, User Journey, Requirement, Git Graph, Mindmap, Packet, Radar, Sankey, Treemap, Venn |
| Translation pending | Agentflow, Architecture, Block, C4, Cynefin, Event Modeling, Ishikawa, Railroad, Swimlanes, TreeView, Use Case, Wardley Map, ZenUML |

The current 5,120-pair matrix covers all 20 implemented families with fresh
...
All 20 implemented families have completed the replacement gate. Together they
have 5,120 accepted same-source pairs:
`4,633 automatic pass / 487 manually reviewed / 0 unresolved` across 320 reviewed contact
...
font-box threshold patterns. All reviewed cases preserve expected text, hierarchy, shapes, colors, and edges, avoid clipping
