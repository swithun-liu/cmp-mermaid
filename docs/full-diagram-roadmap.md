...
CMP Mermaid implements 28 of the 33 user-visible diagram families documented
...
| --- | --- |
| Implemented, 256-case detail gate passing | Flowchart, XY Chart, Quadrant Chart, Timeline, Kanban, Sequence, Class, State, Entity Relationship, Gantt, Pie, User Journey, Requirement, Git Graph, Mindmap, Packet, Radar, Sankey, Treemap, Venn, Ishikawa, Cynefin, Event Modeling, Agentflow, Block, Swimlanes, Architecture, C4 |
| Translation pending | Railroad, TreeView, Use Case, Wardley Map, ZenUML |

The current 7,168-pair matrix covers all 28 implemented families with fresh
...
All 28 implemented families have completed the replacement gate. Together they
have 7,168 accepted same-source pairs:
`6,362 automatic pass / 806 manually reviewed / 0 unresolved` across 448 reviewed contact
...
equivalent orthogonal routes. Architecture and C4 each contribute 256
automatic passes.
All
