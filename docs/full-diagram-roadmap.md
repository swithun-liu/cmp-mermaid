...
CMP Mermaid implements 21 of the 33 user-visible diagram families documented
...
| --- | --- |
| Implemented, 256-case detail gate passing | Flowchart, XY Chart, Quadrant Chart, Timeline, Kanban, Sequence, Class, State, Entity Relationship, Gantt, Pie, User Journey, Requirement, Git Graph, Mindmap, Packet, Radar, Sankey, Treemap, Venn, Ishikawa |
| Translation pending | Agentflow, Architecture, Block, C4, Cynefin, Event Modeling, Railroad, Swimlanes, TreeView, Use Case, Wardley Map, ZenUML |

The current 5,376-pair matrix covers all 21 implemented families with fresh
...
All 21 implemented families have completed the replacement gate. Together they
have 5,376 accepted same-source pairs:
`4,889 automatic pass / 487 manually reviewed / 0 unresolved` across 336 reviewed contact
...
font-box threshold patterns. Ishikawa contributes 256 automatic passes. All
