...
- 145 production scenarios
- 88 conformance scenarios created independently from the demo gallery
- 16 required capability points for each of the first nine diagram types and
  18 for Requirement and 24 for Git Graph
- 186/186 declared capability points covered
- 2,816 additional visual-matrix sources: 256 per diagram type
- 2,816 separate Native-only randomized stress inputs
...
- one of the 186 required capability points has no conformance case;
...
for determinism, and renders all 11 diagram types across all 11 built-in
themes.
...
profiles. All 2,816 sources render in the Native core test and all 2,816
...
2,816 independent topologies. The separate randomized stress corpus remains
